...
\draw[flow,orange!70!black] (top.west) -| ++(-5.0,-0.4)
      node[lbl,pos=0.75,left]{\texttt{wr/rd\_en,addr}} |- (bram.west);
\draw[flow,orange!70!black] (top.west) -| ++(-7.5,-0.8)
      node[lbl,pos=0.8,left]{\texttt{tx\_data,send}} |- (tx.north);
\end{tikzpicture}
